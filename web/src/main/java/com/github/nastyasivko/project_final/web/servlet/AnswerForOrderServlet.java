...
import com.github.nastyasivko.project_final.dao.impl.DefaultCostsDao;
...
public class AnswerForOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Costs> costsList = costsDao.getListCosts(name);
        req.setAttribute("number", listNumber);
        req.setAttribute("costList", costsList);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (answer[0].equals("YES")) {
            userAdministratorDao.saveApprovedOrder(name, userOrderNew, Integer.parseInt(numberRoom[0]), new Costs(null, Integer.parseInt(costRoom[0])));
